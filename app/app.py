...
# Load the trained model
MODEL_PATH = r"C:\Users\mithu\Desktop\osteo_vision\src\models\OSTEO_VISION_MODEL_6_ Knee Osteoarthritis Detection with Fine-Tuned ResNet152V2 on dataset 3 MODEL_6.h5""  # Updated model path
try:
    model = tf.keras.models.load_model(MODEL_PATH)
except Exception as e:
